...
class FragmentUserMemberInfo : BtsppFragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val tv_account_status = v.findViewById<TextView>(R.id.txt_account_status)
        ...
        val tv_member_tip = v.findViewById<TextView>(R.id.txt_upgrade_to_member_tip)

        // Todo 是否终身会员
        if (true) {
            tv_account_status.text = "终身会员"
            tv_member_tip.text = resources.getString(R.string.registerLoginMemberTip)
            tv_member_tip.setTextColor(resources.getColor(R.color.theme01_buyColor))
        } else {
            tv_account_status.text = "普通会员"
            tv_member_tip.text = resources.getString(R.string.registerLoginUpgradeToMemberTip)
