...
class FragmentOtcMerchantListSell : BtsppFragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        _view = inflater.inflate(R.layout.fragment_otc_merchant_list_sell, container, false)
        getDataAndRefreshUI()
        return _view
    }
    ...
    private fun refreshUI() {
        ...
        if (_data.length() == 0){
            ...
            _data.forEach<JSONObject> {
                val view = ViewOtcMerchantCell(_ctx!!,_asset_name,2,it!!)
                layout.addView(view)
            }
        }
    }
