...
//    self.subTitleHeight = 90.0f;
    self.subTitleHeight = 80.0f;    //  REMARK: syalon modifyed ~
    ...
    //  REMARK: 考虑外部参数 TODO syalon modifyed
    _labelTitle.textColor = [ThemeManager sharedThemeManager].textColorMain;
    _viewText.textColor = [ThemeManager sharedThemeManager].textColorMain;
    _contentView.layer.borderColor = [ThemeManager sharedThemeManager].bottomLineColor.CGColor; //Light Grey
