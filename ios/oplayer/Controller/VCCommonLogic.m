...
{
    //  [统计]
    [Answers logCustomEventWithName:@"event_view_userlimitorders" customAttributes:@{@"account":account_id}];
...
{
    //  [统计]
    [Answers logCustomEventWithName:@"event_view_userassets" customAttributes:@{@"account":account_name_or_id}];
