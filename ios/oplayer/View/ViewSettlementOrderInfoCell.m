...
@interface ViewSettlementOrderInfoCell()
{
    NSDictionary*   _item;
...
@implementation ViewSettlementOrderInfoCell
...
//        _lbData = [self auxGenLabel:[UIFont systemFontOfSize:13]];
